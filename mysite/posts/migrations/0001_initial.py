# Generated by Django 4.1.5 on 2023-04-02 13:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hosting_method', models.CharField(choices=[('Y', 'YouTube'), ('S', 'Server')], default='S', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField()),
                ('comments', models.ManyToManyField(blank=True, to='posts.comment')),
                ('image_paths', models.ManyToManyField(blank=True, to='posts.image')),
                ('poster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('tags', models.ManyToManyField(blank=True, to='posts.tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=300, unique=True)),
                ('comments', models.ManyToManyField(blank=True, to='posts.comment')),
                ('image_paths', models.ManyToManyField(to='posts.image')),
                ('poster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('tags', models.ManyToManyField(blank=True, to='posts.tag')),
            ],
            options={
